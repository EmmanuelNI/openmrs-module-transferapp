...
public interface TransferAdminDao {
	...
	ReceivingService getReceivingService(Integer receivingServiceId);

	ReceivingFacility getReceivingFacilityByCode(Integer sendingLocationId, String facilityCode);

	ReceivingFacility saveReceivingFacility(ReceivingFacility facility);

	ReceivingService saveReceivingService(ReceivingService service);
